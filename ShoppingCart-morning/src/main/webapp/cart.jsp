...
<div class="container">
<div class="d-flex py-3"><h3 style="color: red;">Total Price:$ ${(total>0)?dcf.format(total):0}</h3><a class="mx-3 btn btn-secondary" href="cart-check-out">Check Out</a></div>
...
<tbody>
	...
	if(cart_list !=null){
		for(Cart c:cartProduct){%>
			...
			<a class="btn btn-sm btn-decre" href="quantity-inc-dec?action=dec&id=<%= c.getId()%>"><i class= "fas fa-minus-square"></i></a></a>
